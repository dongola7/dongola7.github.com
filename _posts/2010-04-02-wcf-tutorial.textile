...
This example code is available on GitHub at http://github.com/dongola7/wcf_chatter.  The repository contains a working VS 2008 solution implementing the chat service described here.
